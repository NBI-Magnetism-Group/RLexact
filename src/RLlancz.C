...
extern void ApplySparse(komplex *vectin, komplex *vectout, long long *k, struct FLAGS *);
...
double LowestLanczos(long long k[NSYM], komplex *resvect, long long *Nener, long long flag, struct FLAGS *input_flags)
{
  double scale, emin;
  long long j, Nvec;
  long long i;
...
// convergence.
long long LanczosLoop(long long Nvec, long long k[NSYM], komplex *eigvect, struct FLAGS *input_flags)
{
  long long j;
  long long i;
  double emin;
...
double NextLanczos(komplex *vr, komplex *vr_1,
                   komplex *dummy,
                   unsigned long long r, long long k[NSYM], struct FLAGS *input_flags)
{
  long long j;
  long long i;
  double lg, tmp;
